...
class Property(models.Model):
    ...
    MinPrice = models.DecimalField(decimal_places=0, max_digits=27, verbose_name="Minimum Price")
    MaxPrice = models.DecimalField(decimal_places=0, max_digits=27, verbose_name="Maximum Price")
